<template>
  <div class="location-widget">
    <h1>Widget Lokasi</h1>
    <h2>Latitude dan Longitude Anda</h2>
    ...
    <button @click="fetchLocationDetails" class="find-button">Cari Lokasi Anda Saat ini</button>
    ...
    <div v-if="foundLocation" class="location-details">
      ...
      <p><strong>Provinsi:</strong> {{ foundLocation.components.state }}</p>
      <p><strong>Kelurahan:</strong> {{ foundLocation.components.city }}</p>
